      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center"> 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10 w-full">
            ...
            {/* Image 2 */}
            <div 
              className="h-48 md:h-64 bg-gray-300 bg-cover bg-center rounded-sm"
              style={{ backgroundImage: "url('/boot2.png')" }} // Placeholder
            ></div>  
            {/* Image 3 */}
            <div 
              className="h-48 md:h-64 bg-gray-400 bg-cover bg-center rounded-sm"
              style={{ backgroundImage: "url('/boot3.png')" }} // Placeholder
            ></div>
            {/* Image 4 */}
            <div 
              className="h-48 md:h-64 bg-gray-500 bg-cover bg-center rounded-sm"
